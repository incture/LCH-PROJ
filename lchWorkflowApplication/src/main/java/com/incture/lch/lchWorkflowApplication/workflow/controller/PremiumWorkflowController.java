...
public class PremiumWorkflowController 
{
	...
	@GetMapping("/getAllTaskInstanceId")
	public JSONArray getAllTaskInstanceId(String workflowInstanceId) throws ClientProtocolException, IOException, JSONException
	{
		return premiumWorkflowService.getAllTaskInstanceId(workflowInstanceId);
	}
