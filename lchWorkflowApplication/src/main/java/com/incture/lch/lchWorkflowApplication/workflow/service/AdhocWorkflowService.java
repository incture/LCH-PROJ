...
public class AdhocWorkflowService {
	...
	public ResponseMessage callLchAppToUpdateWorkflowTables(WorkflowCustomDto input)
			throws ClientProtocolException, IOException, JSONException {
	...
	public ResponseMessage callLchAppToUpdateWorkflowTables1(WorkflowCustomDto input)
			throws ClientProtocolException, IOException, JSONException {
		MYLOGGER.error("Enter into AdhocOWorkflowService: callLchAppToUpdateWorkflowTables:");
		RestTemplate callRestApi = new RestTemplate();
		...
		try {
			...
			headers.set("Authorization", "Bearer " + bearerToken);
			HttpEntity<WorkflowCustomDto> entity = new HttpEntity<WorkflowCustomDto>(input, headers);
			String responseMessage = callRestApi.postForObject(WorkflowConstants.LCH_APP_URL_FOR_UPDATE2, entity,
					String.class);
			MYLOGGER.error("Enter into AdhocOWorkflowService: callLchAppToUpdateWorkflowTables:responseMessage "
					+ responseMessage);
			ResponseMessage response1 = new ResponseMessage(responseMessage);
	...
	public ResponseMessage callLchAppToUpdateWorkflowTables(AdhocWorkflowCustomDto input)
			throws ClientProtocolException, IOException, JSONException {
		MYLOGGER.error("Enter into AdhocOWorkflowService: callLchAppToUpdateWorkflowTables:");
		RestTemplate callRestApi = new RestTemplate();
		...
		try {
			...
			MYLOGGER.error("Enter into AdhocOWorkflowService: callLchAppToUpdateWorkflowTables:responseMessage "
					+ responseMessage);
			ResponseMessage response2 = new ResponseMessage(responseMessage);
			return response2;
		} catch (Exception e) {
			MYLOGGER.error("AdhocOWorkflowService: callLchAppToUpdateWorkflowTables: error " + e.toString());
		}
	...
	public ResponseMessage updateApprovalWorflowDetails(WorkflowCustomDto obj)
	...
	public ResponseMessage updateApprovalWorflowDetails1(WorkflowCustomDto obj)
			throws ClientProtocolException, JSONException, IOException {
		MYLOGGER.error("AdhocOWorkflowService: updateApprovalWorflowDetails: enter ");
		return callLchAppToUpdateWorkflowTables1(obj);
	}

	public ResponseMessage updateApprovalWorflowDetailsForType4(AdhocWorkflowCustomDto obj)
			throws ClientProtocolException, JSONException, IOException {
